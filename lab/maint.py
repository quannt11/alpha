...
PROTECTED_PATH = re.compile(r"^(bin/lab-guard|bin/lab-deploy|lab/maint\.py|lab/budget\.py|lab\.toml|systemd/|"
                            r"projects/[^/]+/CLAUDE\.md)")
PROTECTED_LINE = re.compile(r"daily_usd|test_mode|test_policy|max_gpus|allowed_gpu_types|per_experiment_usd|"
                            r"approval_over_usd|operators|RUNPOD_API_KEY|SHADEFORM_API_KEY|VAST_API_KEY|DISCORD_BOT_TOKEN|SECRET_ENV|"
...
SECRET_ENV = ("DISCORD_BOT_TOKEN", "RUNPOD_API_KEY", "SHADEFORM_API_KEY", "VAST_API_KEY", "DISCORD_BOT_TOKEN_ARBOS_BITTENSOR", "CLAUDE_CODE_OAUTH_TOKEN",
